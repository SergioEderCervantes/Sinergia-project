...
export default function HeroDesc() {
  return (
    <div className="flex flex-col items-center px-16 text-center text-5xl text-gray-500 lg:w-1/2 lg:text-justify">
      <h2 className="text-gunmetal-600 my-2">Elevate your Brand</h2>
      <img className="my-8 w-1/4 lg:hidden" src="/vite.svg" alt="logo" />
      ...
      <div className="my-8 flex w-full flex-col gap-4 md:my-0 lg:flex-row">
