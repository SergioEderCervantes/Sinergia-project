...
export default function Card({ icon: Icon, service }) {
  ...
  const onHoverStart = contextSafe(() => {
  ...
  return (
    <div
      ...
      className="group bg-lavender-web-100 my-2 h-fit w-1/4 min-w-2xs rounded-xl p-4 transition-colors duration-1000 ease-out"
      style={{
        background: isHovered ? service.color : undefined,
      }}
    >
